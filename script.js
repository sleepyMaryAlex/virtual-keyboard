...
function showContent() {
    const content = `<div class="wrapper">
                        ...
                        <div class="keyboard">
                            <div class="first-row">
                                <div class="key" data-i18="slash-quote" id='Backquote'>\`</div>
                            ...
                            <div class="second-row">
                                ...
                                <div class="key" data-i18="q" id="KeyQ">q</div>
                                <div class="key" data-i18="w" id="KeyW">w</div>
                                <div class="key" data-i18="e" id="KeyE">e</div>
                                <div class="key" data-i18="r" id="KeyR">r</div>
                                <div class="key" data-i18="t" id="KeyT">t</div>
                                <div class="key" data-i18="y" id="KeyY">y</div>
                                <div class="key" data-i18="u" id="KeyU">u</div>
                                <div class="key" data-i18="i" id="KeyI">i</div>
                                <div class="key" data-i18="o" id="KeyO">o</div>
                                <div class="key" data-i18="p" id="KeyP">p</div>
                                <div class="key" data-i18="[" id="BracketLeft">[</div>
                                <div class="key" data-i18="]" id="BracketRight">]</div>
                                <div class="key" id="Backslash">\\</div>
                                <div class="key control-key" id="Delete">del</div>
                            </div>
                            <div class="third-row">
                                <div class="key control-key middle" id="CapsLock">caps lock</div>
                                <div class="key" data-i18="a" id="KeyA">a</div>
                                <div class="key" data-i18="s" id="KeyS">s</div>
                                <div class="key" data-i18="d" id="KeyD">d</div>
                                <div class="key" data-i18="f" id="KeyF">f</div>
                                <div class="key" data-i18="g" id="KeyG">g</div>
                                <div class="key" data-i18="h" id="KeyH">h</div>
                                <div class="key" data-i18="j" id="KeyJ">j</div>
                                <div class="key" data-i18="k" id="KeyK">k</div>
                                <div class="key" data-i18="l" id="KeyL">l</div>
                                <div class="key" data-i18=";" id="Semicolon">;</div>
                                <div class="key" data-i18="quotes" id="Quote">'</div>
                                <div class="key control-key middle" id="Enter">enter</div>
                            </div>
                            <div class="fourth-row">
                                <div class="key control-key middle" id="ShiftLeft">shift</div>
                                <div class="key" data-i18="z" id="KeyZ">z</div>
                                <div class="key" data-i18="x" id="KeyX">x</div>
                                <div class="key" data-i18="c" id="KeyC">c</div>
                                <div class="key" data-i18="v" id="KeyV">v</div>
                                <div class="key" data-i18="b" id="KeyB">b</div>
                                <div class="key" data-i18="n" id="KeyN">n</div>
                                <div class="key" data-i18="m" id="KeyM">m</div>
                                <div class="key" data-i18="comma" id="Comma">,</div>
